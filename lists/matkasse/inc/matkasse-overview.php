...
final class Matkasse_overview {
	...
	public function add_menu() {
		add_submenu_page('edit.php?post_type=matkasselist', 'Overview', 'Overview', 'manage_options', 'matkasselist-overview', array($this, 'add_page'));
	}

	public function add_page() {
		wp_enqueue_style('em-matkasselist-admin-style', LANLIST_PLUGIN_URL . 'assets/css/admin/em-matkasselist.css', array(), '1.0.0');
		...
		foreach ($posts as $post) {
			...
			if (strpos($post->post_content, '[mat') !== false) {
				preg_match_all('/\[mat.*?\]/', $post->post_content, $matches);
