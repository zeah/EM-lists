...
final class Lan_dk_doc {
	...
	public function add_doc($data) {
		$data['emlanlistdk']['title'] = '<h1 id="emlanlistdk">Lånlist Sverige (Plugin)</h1>';

		$data['emlanlistdk']['index'] = '<li><h2><a href="#emlanlistdk">Lånlist Sverige (Plugin)</a></h2>
											<ul>
												<li><a href="#emlanlistdk-shortcode">Shortcode</a></li>
												<li><a href="#emlanlistdk-aldri">Aldri vis</a></li>
												<li><a href="#emlanlistdk-sort">Sorting order</a></li>
												<li><a href="#emlanlistdk-overview">Overview</a></li>
											</ul>
										</li>';
		$data['emlanlistdk']['info'] = '<li id="emlanlistdk-shortcode"><h2>Shortcodes</h2>
										<ul>
											<li><b>[lan]</b>
										...
										<li id="emlanlistdk-aldri"><h2>Aldri vis</h2>
										<p>If tagged, then the loan will never appear on the front-end.</p>
										</li>
										</li>
										<li id="emlanlistdk-sort"><h2>Sorting order</h2>
										...
										<li id="emlanlistdk-overview"><h2>Overview</h2>
										<p> The <a target="_blank" href="'.get_site_url().'/wp-admin/edit.php?post_type=emlanlistdk&page=emlanlistdk-overview">overview page</a> will show every post and page and whether or not there are
