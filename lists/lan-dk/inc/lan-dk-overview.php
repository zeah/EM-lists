...
final class Lan_dk_overview {
	...
	public function add_menu() {
		add_submenu_page('edit.php?post_type=emlanlistdk', 'Overview', 'Overview', 'manage_options', 'emlanlistdk-overview', array($this, 'add_page'));
	}

	public function add_page() {
		wp_enqueue_style('em-lanlist-dk-admin-style', LANLIST_SE_PLUGIN_URL . 'assets/css/admin/em-lanlist-dk.css', array(), '1.0.1');
