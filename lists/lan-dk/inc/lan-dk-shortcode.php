...
final class Lan_dk_shortcode {
	...
	private function wp_hooks() {
		...
		else add_shortcode('lan-dk', array($this, 'add_shortcode'));

		// loan thumbnail
		if (!shortcode_exists('lan-bilde')) add_shortcode('lan-bilde', array($this, 'add_shortcode_bilde'));
		else add_shortcode('lan-dk-bilde', array($this, 'add_shortcode_bilde'));
	...
	public function add_css() {
        wp_enqueue_style($this->name.'-style', LAN_DK_PLUGIN_URL.'assets/css/pub/em-lanlist-dk.css', array(), '1.0.0', '(min-width: 801px)');
        wp_enqueue_style($this->name.'-mobile', LAN_DK_PLUGIN_URL.'assets/css/pub/em-lanlist-dk-mobile.css', array(), '1.0.0', '(max-width: 800px)');
	}
