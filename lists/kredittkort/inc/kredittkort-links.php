...
final class Kredittkort_links {
	...
	public function add_page($name) {
		...
		echo '<table class="'.KREDITTKORT.'-overview-links"><tr><th></th><th>Name</th><th>Button Link</th></tr>';
	...
	public function add_menu($name) {
		add_submenu_page('edit.php?post_type='.KREDITTKORT, 'Links', 'Links', 'manage_options', KREDITTKORT.'-links', [$this, 'add_page']);
	}
}