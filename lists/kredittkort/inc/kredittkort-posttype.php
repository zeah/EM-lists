...
require_once 'kredittkort-taxonomy.php';
require_once 'kredittkort-edit.php';
require_once 'kredittkort-overview.php';

/**
 * 
 */
final class Kredittkort_posttype {
	/* singleton */
	...
	private function __construct() {
		Kredittkort_edit::get_instance();
		Kredittkort_taxonomy::get_instance();
	...
	*/
	public function create_cpt() {
		...
		EM_lists::create_cpt(KREDITTKORT, 'Kredittkort', 'Kredittkort NO', 'dashicons-id');
	}
}